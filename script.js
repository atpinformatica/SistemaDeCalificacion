...
const baseDeDatosAlumnos = {
    "MAÑANA": {
        ...
        "3 A": [ { "dni": "1", "nombre": "AGUIRRE MONTIVERO, Santiago Emanuel" },
                ...
                { "dni": "4", "nombre": "AQUITO, Maia Tahiana"},
                { "dni": "5", "nombre": "ITURRIZA VILLALBA, Daniela" },
                { "dni": "6", "nombre": "LUNA RAMIREZ, Manuel Alejandro" },
                { "dni": "7", "nombre": "MATOS QUINTANA, Joaquin Ignacio" },
                { "dni": "8", "nombre": "NAMUNCURÁ ANCATRUZ, Ceferino José" },
                { "dni": "9", "nombre": "NARDONI, Agostina" },
                { "dni": "10", "nombre": "NUÑEZ, Mia Jazmín" },
                { "dni": "11", "nombre": "ORTEGA MENA, Facundo Benjamin" },
                { "dni": "12", "nombre": "TORRES EPULLAN, Sahira Eluney" },
                { "dni": "13", "nombre": "ULLOA, Axel Nehemias" },
                { "dni": "14", "nombre": "VEJARES, Bianca Solange" },
                { "dni": "15", "nombre": "AQUITO, Maia Tahiana" }],
